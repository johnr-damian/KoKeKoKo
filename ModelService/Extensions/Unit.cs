...
namespace ModelService.Types
{
    ...
    public partial class Unit
    {
        ...
        public static Dictionary<string, UnitDefinitions> Definitions = new Dictionary<string, UnitDefinitions>()
        {
            ...
            ["TERRAN_BARRACKSREACTOR"] = new UnitDefinitions(400, 0, 0, 0, 1, false),
            ["TERRAN_BARRACKSTECHLAB"] = new UnitDefinitions(400, 0, 0, 0, 1, false),
            ...
            ["TERRAN_FACTORYREACTOR"] = new UnitDefinitions(400, 0, 0, 0, 1, false),
            ["TERRAN_FACTORYTECHLAB"] = new UnitDefinitions(400, 0, 0, 0, 1, false),
            ["TERRAN_GHOSTACADEMY"] = new UnitDefinitions(1250, 0, 0, 0, 1, false),
            ["TERRAN_STARPORT"] = new UnitDefinitions(1300, 0, 0, 0, 1, false),
            ["TERRAN_STARPORTREACTOR"] = new UnitDefinitions(400, 0, 0, 0, 1, false),
            ["TERRAN_STARPORTTECHLAB"] = new UnitDefinitions(400, 0, 0, 0, 1, false),
        ...
        public static Dictionary<string, CostWorth> Values = new Dictionary<string, CostWorth>()
        {
            ...
            ["TERRAN_BARRACKSREACTOR"] = new CostWorth(11, 50, 50, 0),
            ["TERRAN_BARRACKSTECHLAB"] = new CostWorth(11, 50, 25, 0),
            ...
            ["TERRAN_FACTORYREACTOR"] = new CostWorth(11, 50, 50, 0),
            ["TERRAN_FACTORYTECHLAB"] = new CostWorth(11, 50, 25, 0),
            ["TERRAN_GHOSTACADEMY"] = new CostWorth(11, 150, 100, 0),
            ["TERRAN_STARPORT"] = new CostWorth(11, 150, 100, 0),
            ["TERRAN_STARPORTREACTOR"] = new CostWorth(11, 50, 50, 0),
            ["TERRAN_STARPORTTECHLAB"] = new CostWorth(11, 50, 25, 0),
